...
class ObsInfoPage(Page.ButtonPage):
    ...
    def __init__(self, frame, name, title):
        ...
        self.items = {
            'prop-id': self.dc.Text(300, 20, text='', font="Roboto;normal;black",
                                    fontsize=16, color=self.black,
                                    coord='window'),
            'timer': self.dc.Text(550, 270, text='', font="Roboto;normal;black",
                                  fontsize=140, color=self.orange,
                                  coord='window'),
            'obsinfo1': self.dc.Text(10, 75, text='', font="Roboto Condensed;italic;bold",
                                     fontsize=44, color=self.blue,
                                     coord='window'),
            'obsinfo2': self.dc.Text(250, 120, text='',
                                     font="Roboto Condensed;italic;bold",
                                     fontsize=40, color=self.green,
                                     coord='window'),
            'obsinfo3': self.dc.Text(10, 160, text='',
                                     font="Roboto Condensed;italic;bold",
                                     fontsize=20, color=self.black,
                                     coord='window'),
